...
2. A config file can be used to generate a policy fragment for a particular image.
This is useful in cases where stable key release policies are required.
This option is called "image-attached fragments".
