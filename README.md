...
Each directory is tested with [confidential-aci-testing](https://github.com/microsoft/confidential-aci-testing) (currently using version 1.2.3) and therefore contains:
